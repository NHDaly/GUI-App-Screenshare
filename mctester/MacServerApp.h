...
#ifndef __MultiComputer_Tester__MacServerApp___
#define __MultiComputer_Tester__MacServerApp___
...
private:
    ...
    virtual bool receive_mouse_down(GUI::DispPoint coord);
    virtual bool receive_mouse_up(GUI::DispPoint coord);
    virtual bool receive_mouse_motion(GUI::DispPoint coord, GUI::DispPoint rel_motion);
...
#endif /* defined(__MultiComputer_Tester__MacServerApp___) */
